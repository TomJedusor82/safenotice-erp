...
function Side({goNew,navI,view,setView,etabs,showNE,neN,setNeN,neV,setNeV,addEtab,setShowNE,fEtab,setFEtab}){return<div style={{width:230,background:"var(--bg1)",borderRight:"1px solid var(--b1)",display:"flex",flexDirection:"column",minHeight:"100vh",position:"sticky",top:0,zIndex:10}} className="do">
...
export default function SafeNotice(){
  ...
  const sidebarProps={goNew,navI,view,setView,etabs,showNE,neN,setNeN,neV,setNeV,addEtab,setShowNE,fEtab,setFEtab};
